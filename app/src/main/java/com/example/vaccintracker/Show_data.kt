...
class Show_data : AppCompatActivity() {
    ...
    //lateinit var txtAvalablity : TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // txtAvalablity = findViewById(R.id.txtAvaliablity)
            ...
            JsonObjectRequest(Request.Method.GET, url, null,{response ->
                ...
                try {
                    ...
                    for (i in 0 until centerArray.length()) {
                       ...
                       /* if(avaliableCapacity > 4)
                            txtAvalablity.setTextColor(Color.GREEN)

                        if(avaliableCapacity < 1)
                            txtAvalablity.setTextColor(Color.RED)

                        if(avaliableCapacity < 4 && avaliableCapacity>0)
                            txtAvalablity.setTextColor(Color.YELLOW)*/
